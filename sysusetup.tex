...
\sysusetup{
  title                = {SkillRank：面向大规模 Agent Skill 价值发现的云端系统设计与实现},
  title*               = {SkillRank: Design and Implementation of a Cloud-Based System for Value Discovery of Agent Skills at Scale},
  author               = {蔡可豪},
  author*              = {Cai Kyrie},
  speciality           = {计算机科学与技术},
