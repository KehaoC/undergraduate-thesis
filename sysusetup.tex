...
\sysusetup{
  title                = {SkillRank：面向大规模 Agent Skill 价值发现的系统设计与实现},
  title*               = {SkillRank: Design and Implementation of a System for Value Discovery of Agent Skills at Scale},
  author               = {蔡可豪},
  author*              = {Cai Kyrie},
  speciality           = {计算机科学与技术},
  speciality*          = {Computer Science and Technology},
  supervisor           = {林倞教授},
  supervisor*          = {Prof. LIN Liang},
  ...
  % professional-type*   = {Professional degree type},
   ...
   student-id           = {22336018},  % 学号，本科生需要填写
...
% Noto CJK 的字形覆盖更完整，自动构建环境可用时优先使用，避免缺字。
